...
import { utils, Signer, BigNumber, providers, constants } from 'ethers';
import _defineProperty from '@babel/runtime/helpers/esm/defineProperty';
import _assertThisInitialized from '@babel/runtime/helpers/esm/assertThisInitialized';
import _toArray from '@babel/runtime/helpers/esm/toArray';
import _typeof from '@babel/runtime/helpers/esm/typeof';
import { FunctionFragment, Interface, EventFragment } from '@ethersproject/abi';
...
function resolveAddress(value) {
  ...
  if (Signer.isSigner(value) && value.address) {
    return resolveAddress(value.address);
  }
...
function enhanceResponse(fn, response) {
  ...
  enhanced.wait = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(confirmations) {
                          ...
                          switch (_context3.prev = _context3.next) {
                            ...
                            case 16:
                              ...
                              resolve(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
                                ...
                                nonce: BigNumber.from(_this2.options.nonce).toNumber()
                              }), _this2.options.value && {
                                value: BigNumber.from(_this2.options.value)
                              }), _this2.options.price && {
                                gasPrice: BigNumber.from(_this2.options.price)
                              }), _this2.options.gas && {
                                gasLimit: BigNumber.from(_this2.options.gas)
                              }));
                              _context3.next = 23;
                              break;
...
var SendFunction = /*#__PURE__*/function (_CallFunction) {
  ...
  _createClass(SendFunction, [{
    key: "estimate",
    value: function () {
      var _estimate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
        var tx;
...
var ConstructorFunction = /*#__PURE__*/function (_ContractFunction2) {
  ...
  _createClass(ConstructorFunction, [{
    key: "call",
    value: function () {
      var _call2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
        var tx;
    ...
    key: "estimate",
    value: function () {
      var _estimate2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
        var tx;
    ...
    key: "populate",
    value: function () {
      var _populate2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11() {
        var _this5 = this;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                if (!this.populated || refresh) {
                  this.populated = new Promise( /*#__PURE__*/function () {
                    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(resolve, reject) {
                      var inputs, args, data, from;
                        ...
                        while (1) {
                          switch (_context10.prev = _context10.next) {
                            ...
                            case 3:
                              ...
                              data = utils.hexlify(utils.concat([_this5.options.bytecode, _this5.contract.abi.encodeDeploy(args)]));
                            ...
                            case 18:
                              ...
                              resolve(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
                                ...
                                nonce: BigNumber.from(_this5.options.nonce).toNumber()
                              }), _this5.options.price && {
                                gasPrice: BigNumber.from(_this5.options.price)
                              }), _this5.options.gas && {
                                gasLimit: BigNumber.from(_this5.options.gas)
                              }));
                              _context10.next = 25;
                              break;
...
function deploy(contract, bytecode) {
  ...
  var hex = utils.hexlify(bytecode !== null && bytecode !== void 0 ? bytecode : '', {
...
var Doppelganger = /*#__PURE__*/function (_Contract) {
  ...
  _createClass(Doppelganger, null, [{
    key: "deploy",
    value: function () {
      var _deploy2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(signer) {
        var address,
            contract,
            _len,
            args,
...
function stub(doppelganger, contract, func, params) {
  var encoder = utils.defaultAbiCoder;
  return {
    ...
    returns: function () {
      var _returns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    ...
    reverts: function () {
      var _reverts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(reason) {
        var _func$inputs3;
...
function _mock() {
  _mock = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(contract) {
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            forward = /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(subject) {
    ...
    var SpecializedContract = /*#__PURE__*/function (_Contract) {
      ...
      _createClass(SpecializedContract, [{
        ...
        value: function mock$1(signer) {
          var address = constants.AddressZero;
...
function randomAddress() {
  var address = utils.hexlify(utils.randomBytes(20));
...
function extractEvent(receipt, event) {
  ...
  var abi = new utils.Interface([fragment]);
...
export { CallFunction, ConstructorFunction, Contract, ContractFunction, SendFunction, contract, deploy, ensureEvent, ensureInterface, extractEvent, isFunctionOptions, mock, randomAddress, resolveAddress, resolveArguments, resolveFunctionOptions, sameAddress };
