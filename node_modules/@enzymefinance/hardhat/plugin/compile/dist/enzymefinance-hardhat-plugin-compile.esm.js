...
import { generateContract, formatOutput } from '@enzymefinance/codegen';
import deepmerge from 'deepmerge';
import { utils } from 'ethers';
import fs from 'fs-extra';
import { extendConfig, task } from 'hardhat/config';
import path from 'path';
import { v as validateDir, r as regexOrString, c as createDirectory, a as clearDirectory } from '../../../dist/utils-04d50688.esm.js';
...
extendConfig(function (config, userConfig) {
  ...
  config.codeGenerator = deepmerge(defaults, provided);
...
task('compile', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(args, env, parent) {
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            return Promise.all(dirs.map( /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(dir) {
                return _regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        return _context.abrupt("return", clearDirectory(dir));
          ...
          case 12:
            _context4.next = 14;
            return Promise.all(dirs.map( /*#__PURE__*/function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(dir) {
                return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        return _context2.abrupt("return", createDirectory(dir));
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 2:
                        ...
                        source = path.join(env.config.paths.root, artifact.sourceName);
                        _context3.next = 6;
...
function _generateAbiFiles() {
  _generateAbiFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(dir, artifacts) {
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return Promise.all(artifacts.map( /*#__PURE__*/function () {
              var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(artifact) {
                var destination;
                return _regeneratorRuntime.wrap(function _callee5$(_context5) {
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        destination = path.resolve(dir, "".concat(artifact.name, ".json"));
                        _context5.next = 3;
...
function _generateBytecodeFiles() {
  _generateBytecodeFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(dir, artifacts) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return Promise.all(artifacts.map( /*#__PURE__*/function () {
              var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(artifact) {
                var destination, content;
                return _regeneratorRuntime.wrap(function _callee7$(_context7) {
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        destination = path.resolve(dir, "".concat(artifact.name, ".bin.json"));
                        content = {
...
function _generateTypeScriptFiles() {
  _generateTypeScriptFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(dir, artifacts) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.next = 2;
            return Promise.all(artifacts.map( /*#__PURE__*/function () {
              var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(artifact) {
                var abi, content, formatted, destination;
                return _regeneratorRuntime.wrap(function _callee9$(_context9) {
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        abi = new utils.Interface(artifact.artifact.abi);
                        content = generateContract(artifact.name, artifact.artifact.bytecode, abi);
                        formatted = formatOutput(content);
                        destination = path.join(dir, "".concat(artifact.name, ".ts"));
                        _context9.next = 6;
