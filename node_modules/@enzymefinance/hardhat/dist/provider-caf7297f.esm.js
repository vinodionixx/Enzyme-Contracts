...
var History = /*#__PURE__*/function () {
  ...
  _createClass(History, [{
    ...
    value: function reset(contract) {
      ...
      var checksum = utils.getAddress(address);
    ...
    value: function record(message) {
      var to = message.to ? utils.hexlify("".concat(message.to)) : '0x';

      if (to === '0x') {
        return;
      }

      var checksum = utils.getAddress(to);
      var data = message.data ? utils.hexlify(message.data) : '0x';
...
var Snapshots = /*#__PURE__*/function () {
  ...
  _createClass(Snapshots, [{
    key: "snapshot",
    value: function () {
      var _snapshot = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(create, id) {
        var revert, snapshot;
    ...
    key: "record",
    value: function () {
      var _record = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(create) {
        var data, id;
    ...
    key: "revert",
    value: function () {
      var _revert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(snapshot, create) {
...
var EthereumTestnetProvider = /*#__PURE__*/function (_providers$StaticJson) {
  ...
  function EthereumTestnetProvider(env) {
    ...
    if (_this.env.network.config.gas !== 'auto') {
      _this.gas = BigNumber.from(_this.env.network.config.gas).mul(_this.env.network.config.gasMultiplier);
    }

    if (_this.env.network.config.gasPrice !== 'auto') {
      _this.gasPrice = BigNumber.from(_this.env.network.config.gasPrice);
    }
  ...
  _createClass(EthereumTestnetProvider, [{
    ...
    value: function () {
      var _getSignerWithAddress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(addressOrIndex) {
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.t0 = SignerWithAddress;
                _context2.next = 3;
    ...
    key: "estimateGas",
    value: function () {
      var _estimateGas = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(transaction) {
        var _this$gas;
    ...
    key: "getGasPrice",
    value: function () {
      var _getGasPrice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
        var _this$gasPrice;
...
export { EthereumTestnetProvider as E, History as H, Snapshots as S };
