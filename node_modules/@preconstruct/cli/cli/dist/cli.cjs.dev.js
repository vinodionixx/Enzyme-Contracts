...
let createLanguageServiceHostClass = typescript => {
  ...
  return _temp = class LanguageServiceHost {
    constructor(parsedConfig, transformers) {
      _defineProperty$6(this, "parsedConfig", void 0);

      _defineProperty$6(this, "transformers", void 0);

      _defineProperty$6(this, "cwd", void 0);

      _defineProperty$6(this, "snapshots", void 0);

      _defineProperty$6(this, "versions", void 0);

      _defineProperty$6(this, "fileNames", void 0);

      _defineProperty$6(this, "service", void 0);
...
async function createDeclarationCreator(dirname, pkgName) {
  ...
  let {
    ...
    options,
    program
  } = await (normalizePath(configFileName) === normalizePath(path__default.join(dirname, "tsconfig.json")) ? nonMemoizedGetService(typescript, configFileName) : getService(typescript)(configFileName));
  ...
  return {
      ...
      function searchDeps(deps) {
        for (let dep of deps) {
          ...
          for (let {
            ...
            if (resolvedModule) {
              if (!allDeps.has(resolvedModule.resolvedFileName) && !resolvedModule.isExternalLibraryImport && resolvedModule.resolvedFileName.includes(normalizedDirname)) {
    ...
    getDeclarationFiles: async filename => {
      ...
      return output.outputFiles.reduce((emitted, {
        name,
        text
      }) => {
